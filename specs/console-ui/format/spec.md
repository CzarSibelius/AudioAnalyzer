...
UI specs document what appears on each line of the console so that implementers, testers, and agents can refer to exact row numbers and know what each row represents. Screenshots come from the [screen-dump](../../../docs/adr/0046-screen-dump-ascii-screenshot.md) feature (ASCII screenshot).

## Layout and alignment

Layout follows [ADR-0050](../../../docs/adr/0050-ui-alignment-blocks-label-format.md):
...
- **Application modes** (Preset editor, Show play, General settings): [ui-spec-application-modes.md](../application-modes/spec.md).
- New UI layout specs in `docs/` (e.g. mode-specific or feature-specific `ui-spec-*.md` files).
- **Settings-related surfaces** (shared vocabulary): [ui-spec-settings-surfaces.md](../settings-surfaces/spec.md); per-surface: [ui-spec-general-settings-hub.md](../general-settings-hub/spec.md), [ui-spec-device-selection-modal.md](../device-selection-modal/spec.md), [ui-spec-preset-settings-modal.md](../preset-settings-modal/spec.md).
