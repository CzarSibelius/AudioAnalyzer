...
This document describes the **title breadcrumb line** that appears on **row 0** of the terminal for the main header and every modal (full-screen or overlay). See [ADR-0060](../../../docs/adr/0060-universal-title-breadcrumb.md) and [ADR-0036](../../../docs/adr/0036-title-bar-injectable-component.md).
