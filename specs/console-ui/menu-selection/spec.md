...
Canonical rules for **keyboard-selected rows** in the console UI: hub menus, full-screen lists, overlay columns, and palette pickers. **ADR:** [ADR-0069](../../../docs/adr/0069-unified-menu-selection-affordance.md). **Implementation:** `MenuSelectionAffordance`, `SettingsSurfacesListDrawing`, `SettingsSurfacesPaletteDrawing`, plus call sites below.
...
- [ui-spec-settings-surfaces.md](../settings-surfaces/spec.md) — hub, device, S modal overview.
- [ADR-0063](../../../docs/adr/0063-uniform-settings-list-and-palette-drawing.md) — where shared list/palette helpers live (plus ADR-0069 for appearance).
