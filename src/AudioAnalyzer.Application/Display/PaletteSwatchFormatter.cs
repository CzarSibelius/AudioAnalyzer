...
public static class PaletteSwatchFormatter
{
    ...
    /// </summary>
    public static int ComputeToolbarPhaseOffset(AudioAnalysisSnapshot analysis, int colorCount)
    {
        if (colorCount <= 0)
        {
            return 0;
        ...
        return Mod(analysis.BeatCount, colorCount);
    }
