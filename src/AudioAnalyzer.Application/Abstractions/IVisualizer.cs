...
/// <summary>
/// Renders the visualization from a per-frame <see cref="VisualizationFrameContext"/> (includes <see cref="VisualizationFrameContext.Analysis"/>). The application uses a single implementation (e.g. TextLayersVisualizer).
...
public interface IVisualizer
{
    ...
    void Render(VisualizationFrameContext frame, VisualizerViewport viewport);
    ...
    IReadOnlyList<LabeledValueDescriptor>? GetToolbarViewports(VisualizationFrameContext frame) => null;
    ...
    string? GetToolbarSuffix(VisualizationFrameContext frame) => null;
