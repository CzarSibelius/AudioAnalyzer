...
/// <summary>Builds the optional toolbar suffix string or labeled viewports for the TextLayers visualizer (layer digits, optional contextual rows, palette).</summary>
public interface ITextLayersToolbarBuilder
{
    ...
    /// <summary>Returns toolbar descriptors with own labels (Layers, optional contextual rows, Palette). Empty when no layers.</summary>
