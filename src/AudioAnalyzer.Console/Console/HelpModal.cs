...
internal static class HelpModal
{
    ...
    public static void DrawContent()
    {
        ...
        System.Console.WriteLine("  V         Cycle to next preset");
        ...
        System.Console.WriteLine("  S         TextLayers settings modal (layer + setting editing, ESC close)");
        ...
        System.Console.WriteLine();
        System.Console.ForegroundColor = ConsoleColor.Cyan;
        System.Console.WriteLine("  PRESETS (press V to cycle)");
        System.Console.ResetColor();
        System.Console.WriteLine("  ─────────────────────────────────────");
        System.Console.WriteLine("  Each preset is a named TextLayers configuration (9 layers + palette).");
        System.Console.WriteLine("  Edit layers with S; presets saved automatically.");
        System.Console.WriteLine();
