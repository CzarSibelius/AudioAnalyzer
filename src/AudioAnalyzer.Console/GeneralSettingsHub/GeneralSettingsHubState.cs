...
{
    /// <summary>Selected menu row index (0 = audio, 1 = BPM source, 2 = application name, 3 = default asset folder, 4 = UI theme, 5 = show render FPS, 6 = show layer render time).</summary>
