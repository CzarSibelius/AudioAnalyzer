...
- LabeledRowComponent and ILabeledRowRenderer remain for header rows, modals, and any other row-based UI that composes Viewport data; the non-tree path (RenderRow with startSlotIndex) is unchanged.
