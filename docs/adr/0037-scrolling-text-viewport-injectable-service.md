...
- The toolbar now uses **ScrollingTextComponent** (IUiComponent) in a **HorizontalRowComponent** (ADR-0056); IScrollingTextViewport remains for single-cell use outside the tree.
- References: [IScrollingTextEngine](../../src/AudioAnalyzer.Application/Abstractions/IScrollingTextEngine.cs), [ScrollingTextViewport](../../src/AudioAnalyzer.Application/ScrollingTextViewport.cs), [ADR-0056](0056-scrolling-text-as-uicomponent.md).
