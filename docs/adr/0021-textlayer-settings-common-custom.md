...
- **Persistence**: JSON has a "Custom" object per layer. Legacy configs with old top-level properties are no longer migrated; per ADR-0029, backup-and-reset applies.
