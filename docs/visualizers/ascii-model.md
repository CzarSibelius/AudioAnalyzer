...
- **Viewport area**: Cost scales roughly with **width × height** of the layer draw region. Use a smaller terminal, or **RenderBounds** ([ADR-0058](../adr/0058-layer-render-bounds.md)) to clip the layer to a smaller rectangle.
