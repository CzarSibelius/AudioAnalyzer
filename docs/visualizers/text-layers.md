...
- Toolbar suffix: shows layers as "123456789" (active in highlight, disabled dimmed); key hints (1–9 select, ←→ type, Shift+1–9 toggle); "Palette (LN): name (P)" for the active layer; "I: next image" when AsciiImage exists
