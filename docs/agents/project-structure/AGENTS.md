...
**Tests** (single project `tests/AudioAnalyzer.Tests/`): mirror production paths per [ADR-0064](../../adr/0064-test-project-mirrors-production-layout.md). **Integration** tests: `Integration/` + namespace `AudioAnalyzer.Tests.Integration`. **Unit-only** run (PowerShell):  
...
See [testing-and-verification.md](../testing-and-verification.md#unit-vs-integration-tests).
