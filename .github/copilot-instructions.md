...
- **Key handling**: Every component/class that handles keypresses must implement IKeyHandler&lt;TContext&gt; or delegate to one; no inline key-handling logic (see ADR-0047 in docs/adr/).
